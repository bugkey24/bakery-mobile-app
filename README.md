...
_(You can replace these placeholders with your own screenshots. Upload your images to a folder in your repository and link them here.)_

|                      Login Screen                      |                  Buyer Dashboard (Grid)                  |                     Cart Screen                      |
| :----------------------------------------------------: | :------------------------------------------------------: | :--------------------------------------------------: |
|     ![Login Screen](path/to/your/login_screen.png)     |   ![Buyer Dashboard](path/to/your/buyer_dashboard.png)   |     ![Cart Screen](path/to/your/cart_screen.png)     |
|                   **Checkout (GPS)**                   |               **Order Success (Animated)**               |              **Admin Dashboard (Menu)**              |
|  ![Checkout Screen](path/to/your/checkout_screen.png)  | ![Order Success Screen](path/to/your/success_screen.png) | ![Admin Dashboard](path/to/your/admin_dashboard.png) |
|               **Admin Order Management**               |                 **Buyer Order History**                  |               **Order Detail/Receipt**               |
| ![Admin Order List](path/to/your/admin_order_list.png) |  ![Buyer Order History](path/to/your/buyer_history.png)  |    ![Order Detail](path/to/your/order_detail.png)    |
